            ...
            <div className="bg-[#002B5B] rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden shadow-2xl" data-aos="zoom-out">
                <div className="relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <button className="open-modal bg-blue-600 text-white px-10 py-5 rounded-2xl font-bold text-lg hover:bg-blue-500 transition-all shadow-xl shadow-blue-600/30">Mulai Lapor Sekarang</button>
